Feature: Registration
  Scenario: Successful Customer Registration
    Given a customer with name "Conrad" "Customer" and cpr "1l-c3asdasdasasddasdskjzxj"
    ...
    Given a merchant with name "Mike" "Merchant" and cvr "l-1zxaasdasd3asdaslkjljp"
